export default {
  ...
  'features.ai.desc': 'Scatta una foto, lascia che l\'IA estragga i dettagli. Creazione delle spese più veloce con meno digitazione e più precisione.',
  'features.ai.title': 'Scansione ricevute con IA',
  ...
  'features.lists.desc': 'Liste della spesa e to-do collaborative. Dalla spesa condivisa alle checklist di progetto con aggiornamenti in tempo reale.',
  'features.lists.title': 'Liste condivise',
  ...
  'features.participants.desc': 'Discuti delle spese, allega file ai commenti e reagisci con le emoji. Mantieni la conversazione proprio accanto ai numeri.',
  ...
  'filters.all': 'Tutto',
  'filters.community': 'Comunità',
  'filters.daily': 'Vita quotidiana',
  'filters.travel': 'Svago e viaggi',
  ...
  'littleThings.feedback.desc': 'Segnala bug o suggerisci funzionalità direttamente dall\'app. Traccia la cronologia dei tuoi feedback e chatta con il nostro team.',
  'littleThings.feedback.title': 'Feedback e supporto',
  'littleThings.maps.desc': 'Incolla un URL di Google Maps ed estrarremo automaticamente il nome del luogo e l\'indirizzo per la tua spesa.',
  'littleThings.maps.title': 'Analisi intelligente della posizione',
  'littleThings.names.desc': 'Trappole di focus, target auto-focus, ripristino focus alla chiusura, skip link per screen reader, tooltip su azioni disabilitate e layout RTL-aware per lingue come l\'arabe.',
  'littleThings.names.title': 'Accessibilità integrata',
  'littleThings.reactions.desc': 'Conferma i pagamenti, festeggia i saldi o semplicemente reagisci a quella cena costosa con un semplice tocco.',
  'littleThings.reactions.title': 'Reazioni con emoji',
  ...
  'narrative.step1.desc': 'Crea gruppi, invita amici e stabilisci le regole.',
  'narrative.step1.title': 'Organizzati',
  'narrative.step2.desc': 'Aggiungi spese, ricevute e commenti. In qualsiasi valuta.',
  'narrative.step2.title': 'Traccia tutto',
  'narrative.step3.desc': 'Vedi chi deve cosa a chi e rimborsa in modo efficiente.',
  'narrative.step3.title': 'Salda i conti',
  ...
  'whatsItFor.reduceTransactions.desc': 'Accumula le spese, salda dopo. Ottimizziamo chi paga chi, così saldi meno spesso.',
  'whatsItFor.reduceTransactions.title': 'Riduci i bonifici',
  ...
  'whatsItFor.gifting.desc': 'Compleanni, Natale e regali di gruppo. Dividi regali e sorprese condivise senza inseguire nessuno.',
  'whatsItFor.gifting.title': 'Regali e feste',
  'whatsItFor.celebrations.desc': 'Feste, cene e grandi serate. Dividi location, biglietti e conti senza fogli di calcolo.',
  'whatsItFor.celebrations.title': 'Eventi e celebrazioni',
  'whatsItFor.weddings.desc': 'Addii al nubilato/celibato, weekend, cerimonie. Dividi fornitori, affitti e regali condivisi senza caos.',
  'whatsItFor.weddings.title': 'Matrimoni & grandi momenti',
  'whatsItFor.sports.desc': 'Quote squadra, divise, fee tornei. Mantieni chiaro il contributo di tutti.',
  'whatsItFor.sports.title': 'Sport & leghe',
  'whatsItFor.work.desc': 'Pasti in ufficio, offsite e rimborsi condivisi. Chiudete senza tira-e-molla.',
  'whatsItFor.work.title': 'Uscite lavoro & pranzi di team',
  'whatsItFor.school.desc': 'Gite, quote club, acquisti di gruppo. Traccia e dividi senza fogli di calcolo.',
  'whatsItFor.school.title': 'Scuola & club',
  'whatsItFor.renovations.desc': 'Materiali DIY, strumenti condivisi, contractor. Tieni traccia di chi ha pagato cosa.',
  'whatsItFor.renovations.title': 'Ristrutturazioni & progetti condivisi',
  'whatsItFor.subscriptions.desc': 'Pacchetti streaming, software, account condivisi. Tieni in ordine i costi.',
  'whatsItFor.subscriptions.title': 'Abbonamenti & servizi condivisi',
} as const;
