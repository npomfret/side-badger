export default {
  ...
  'comingSoon.lists.desc': '共同買い物リストとToDoリスト。共有の食料品からプロジェクトのチェックリストまで。',
  'comingSoon.lists.title': '共有リスト',
  'comingSoon.mobile.desc': '外出先での費用追跡用にiOSとAndroidアプリ。支払った直後に費用を追加。',
  'comingSoon.mobile.title': 'ネイティブモバイルアプリ',
  'comingSoon.polls.desc': '夕食が決まらない？投票を作成してグループで決めましょう。揉め事なしの意思決定。',
  'comingSoon.polls.title': 'グループ投票',
