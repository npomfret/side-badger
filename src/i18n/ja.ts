export default {
  ...
  'features.ai.desc': '写真を撮るだけでAIが詳細を抽出。入力の手間を減らし、より速く正確に支出を作成できます。',
  'features.ai.title': 'AIレシートスキャン',
  ...
  'features.lists.desc': '買い物リストやToDoを共同で管理。共有の食料品からプロジェクトのチェックリストまで、リアルタイムで更新。',
  'features.lists.title': '共有リスト',
  'features.noTracking.desc': '広告なし、トラッキングピクセルなし、データ販売なし。アプリの動作に必要な情報だけを収集しています。',
  'features.noTracking.title': 'トラッキングなし',
  'features.participants.desc': '支出についての相談、コメントへのファイル添付、絵文字でのリアクション。会話を数字のすぐそばに。',
  ...
  'filters.all': 'すべて',
  'filters.community': 'コミュニティ',
  'filters.daily': '日常生活',
  'filters.travel': '楽しみ＆旅行',
  ...
  'littleThings.feedback.desc': 'アプリから直接バグ報告や機能提案ができます。フィードバック履歴の確認や、チームとのチャットも可能です。',
  'littleThings.feedback.title': 'フィードバックとサポート',
  'littleThings.maps.desc': 'GoogleマップのURLを貼り付けるだけで、場所の名前と住所を自動的に抽出して支出に追加します。',
  'littleThings.maps.title': 'スマートな位置情報解析',
  ...
  'littleThings.reactions.desc': '支払いの確認、精算のお祝い、あるいは高い夕食へのリアクションも、タップひとつで。',
  'littleThings.reactions.title': '絵文字リアクション',
  ...
  'narrative.step1.desc': 'グループを作成し、友達を招待し、ルールを設定。',
  'narrative.step1.title': '整理する',
  'narrative.step2.desc': '費用、レシート、コメントを追加。どの通貨でも。',
  'narrative.step2.title': 'すべてを記録',
  'narrative.step3.desc': '誰が誰にいくら借りているか確認し、効率的に精算。',
  'narrative.step3.title': '精算する',
