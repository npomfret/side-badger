export default {
  ...
  'comingSoon.receipts.title': 'Kvīšu augšupielāde',
  'comingSoon.receipts.desc': 'Pievienojiet kvīšu fotogrāfijas jebkuriem izdevumiem. Nekad vairs nepazaudējiet iztērētās summas.',
  ...
  // Pricing page
  'pricing.meta.title': 'Cenas - Side Badger | Bez maksas tagad',
  'pricing.meta.description': 'Side Badger pašlaik ir bez maksas, bez slēptām maksām, bez reklāmām un bez izsekošanas. Uzziniet, kāpēc mēs to piedāvājam bez maksas.',
  'pricing.hero.price1': '$99/mēn.',
  'pricing.hero.price2': '$49/mēn.',
  'pricing.hero.price3': '$9/mēn.',
  'pricing.hero.finalPrice': '$0',
  'pricing.hero.subtitle': 'Bez maksas tagad. Nav nepieciešama kredītkarte.',

  // Full Badger Plan
  'pricing.plan.badge': 'Pašreizējais plāns',
  'pricing.plan.name': 'Pilnais āpsis',
  'pricing.plan.currency': '$',
  'pricing.plan.amount': '0',
  'pricing.plan.period': '/mēn.',
  'pricing.plan.description': 'Viss. Viss no tā. Bez ierobežojumiem, kamēr tas turpinās.',
  ...
  'pricing.enterprise.badge': 'Uzņēmums',
  'pricing.enterprise.name': 'Mega āpsis',
  ...
  'pricing.enterprise.alert': '🦡 HONK HONK! Tikai joks, nav uzņēmuma līmeņa. Bezmaksas plānā ir viss. Izmantojiet to tā vietā!',
  ...
  'pricing.faq.q4.answer': 'Kāpēc gan ne āpsis? Āpši ir apņēmīgi, izdomas bagāti un labi strādā grupās. Tāpat kā jūs, kad mēģināt noskaidrot, kurš par ko ir parādā Airbnb.',
